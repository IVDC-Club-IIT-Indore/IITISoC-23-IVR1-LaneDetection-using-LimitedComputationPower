...
model = load_model('Trained_model.h5',custom_objects={'dice_loss':dice_loss,'IOU':IOU,'dsc':dsc,'precision_m':precision_m, 'recall_m':recall_m, 'f1_m':f1_m})
...
video_capture = cv2.VideoCapture(r"C:\Users\ampad\Downloads\Lane_detection_using_DL\input\4.mp4")
...
out=cv2.VideoWriter('4.mp4' , fourcc , 20.0 , (640,480))
count = 0
time_taken = []
