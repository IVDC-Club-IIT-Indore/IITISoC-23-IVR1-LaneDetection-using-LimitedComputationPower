...
model = load_model(r'C:\Users\ampad\Downloads\Lane_detection_using_DL\Trained_model.h5')

# Load the data
train_images = np.load(r"C:\Users\ampad\Downloads\Lane_detection_using_DL\Training_dataset\image_mixed.npy").astype(np.float32)
labels = np.load(r"C:\Users\ampad\Downloads\Lane_detection_using_DL\Training_dataset\label_mixed.npy").astype(np.float32)
labels = labels / 255.0
...
IoU = IOU(y_val_binary.reshape(-1), y_pred_binary.reshape(-1))
